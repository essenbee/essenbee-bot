...
{
    public class Window2 : AdventureLocation
    {
        public Window2(IReadonlyAdventureGame game) : base(game)
        {
            LocationId = Location.Window2;
            Name = "window on pit";
...
{
                new PlayerMove(string.Empty, Location.SecretJunction, "south", "s"),
            };
        }
    }
}
